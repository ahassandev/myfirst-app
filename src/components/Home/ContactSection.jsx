        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-0 md:gap-10 lg:gap-10 items-start lg:px-0">
          <div className="col-span-1 bg-white shadow-[0_0_20px_rgba(0,0,0,0.3)] rounded-2xl overflow-hidden w-full">
            ...
            <p className="ml-8 mt-1 text-gray-600">
              ...
              <a
                href="#"
                className="relative inline-block group text-gray-600 ml-1 hover:text-red-500"
              >
                admin@example.com
                <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
            ...
            <div className="flex gap-6 mt-7 pb-8 ml-8">
              <a
                href="#"
                className="text-3xl p-4 shadow-[0_0_20px_rgba(0,0,0,0.3)] rounded-2xl hover:bg-gradient-to-br hover:from-blue-400 hover:to-pink-500 hover:text-white hover:-translate-y-1 transition-all duration-300"
              >
                <FaWhatsapp />
              </a>
              <a
