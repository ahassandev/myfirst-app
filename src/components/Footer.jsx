        ...
        <div className="py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div>
            <div className="flex items-center gap-3 mt-4">
              ...
              <h1 className="text-xl font-bold cursor-pointer text-black dark:text-white">Ahmad Hassan</h1>
            </div>
          ...
          <div className="mt-3 md:mt-0 lg:mt-0 sm:ml-0 md:ml-0 lg:ml-12">
            <ul className="space-y-2">
                <p className="text-red-500 dark:text-white mb-4 text-xl ">QUICK LINK</p>
                <li><a href="/Features" className="text-xl relative inline-block group hover:text-red-500">Features <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span></a></li>
                <li><a href="/Portfolio" className="text-xl relative inline-block group hover:text-red-500">Portfolio <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span></a></li>
                <li><a href="/Testimonial" className="text-xl relative inline-block group hover:text-red-500">Testimonial <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span></a></li>
                ...
                <li><a href="/Contact" className="text-xl relative inline-block group hover:text-red-500">Contact <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-red-600 transition-all duration-300 group-hover:w-full"></span></a></li>
            </ul>
          </div>  
